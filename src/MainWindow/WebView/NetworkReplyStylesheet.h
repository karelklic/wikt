 ...
 */
#ifndef NETWORKREPLYSTYLESHEET_H_
#define NETWORKREPLYSTYLESHEET_H_

#include <QNetworkReply>
#include <QBuffer>
#include <QTimer>

class NetworkReplyStylesheet : public QNetworkReply
{
  Q_OBJECT
public:
  /// Standard constructor.
  NetworkReplyStylesheet(const QNetworkRequest &request, QObject *parent = 0);
...
#endif /* NETWORKREPLYSTYLESHEET_H_ */
