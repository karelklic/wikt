 ...
 */
#ifndef WIKT_MAIN_WINDOW_WEB_VIEW_NETWORK_REPLY_MEDIA_FILE_H
#define WIKT_MAIN_WINDOW_WEB_VIEW_NETWORK_REPLY_MEDIA_FILE_H

#include <QNetworkReply>
#include <QBuffer>
#include <QTimer>

class NetworkReplyMediaFile : public QNetworkReply
{
  Q_OBJECT
public:
  /// Standard constructor.
  NetworkReplyMediaFile(const QNetworkRequest &request, QObject *parent = 0);
...
#endif /* WIKT_MAIN_WINDOW_WEB_VIEW_NETWORK_REPLY_MEDIA_FILE_H */
