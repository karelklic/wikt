 ...
 */
#ifndef NETWORKREPLYNOTFOUND_H_
#define NETWORKREPLYNOTFOUND_H_

#include <QNetworkReply>
#include <QBuffer>
#include <QTimer>

class NetworkReplyNotFound : public QNetworkReply
{
  Q_OBJECT
public:
  /// Standard constructor.
  NetworkReplyNotFound(const QNetworkRequest &request, QObject *parent = 0);
