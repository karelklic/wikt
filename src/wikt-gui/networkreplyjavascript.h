 ...
 */
#ifndef NETWORKREPLYJAVASCRIPT_H_
#define NETWORKREPLYJAVASCRIPT_H_

#include <QNetworkReply>
#include <QBuffer>
#include <QTimer>

class NetworkReplyJavascript : public QNetworkReply
{
  Q_OBJECT
public:
  /// Standard constructor.
  NetworkReplyJavascript(const QNetworkRequest &request, QObject *parent = 0);
...
#endif /* NETWORKREPLYJAVASCRIPT_H_ */
