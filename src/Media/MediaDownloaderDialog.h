 ...
 */
#ifndef MEDIADOWNLOADERDIALOG_H
#define MEDIADOWNLOADERDIALOG_H

#include <QDialog>
#include "ui_MediaDownloaderDialog.h"
...
class MediaDownloaderDialog : public QDialog
{
  Q_OBJECT
public:
  MediaDownloaderDialog(QWidget *parent = 0);
...
private:
  Ui::MediaDownloaderDialogClass ui;
